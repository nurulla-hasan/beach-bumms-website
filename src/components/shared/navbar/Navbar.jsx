...
const Navbar = () => {
  ...
  return (
    <div className="md:h-[96px] h-[64px] ">
      ...
      >
        <div className="max-w-[1248px] 3xl:max-w-[1365px] mx-auto px-4 sm:px-6 lg:px-8 py-2 bg-black md:rounded-full">
          <div className="flex items-center justify-between h-16">
            {/* Logo */}
            <div className="flex-shrink-0">
              <Link href="/">
                <Image src="/images/nav-logo.svg" alt="Beach Bums" width={500} height={500} className="h-auto w-16 md:w-18" />
              </Link>
            </div>
